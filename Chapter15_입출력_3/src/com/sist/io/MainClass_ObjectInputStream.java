...
class Sawon implements Serializable{
	...
	private String loc;
	private String job;
	// Serializable를 implements하면
	// => sabun name dept loc job => 연속적인 메모리에 저장
...
public class MainClass_ObjectInputStream {
	...
	public static void main(String[] args) {
		...
		list.add(new Sawon(3,"박문수","자재부","제주","과장"));
		list.add(new Sawon(4,"강감찬","총무부","인천","사원"));
		list.add(new Sawon(5,"조규성","축구부","서울","9번"));
