...
//		try {
//			FileOutputStream fos=new FileOutputStream("c:\\download\\sawon.txt",true); // 파일에 저장
//			// w = 파일을 새롭게 생성(create)
...
//			sa.setLoc(scan.next());
//			String save=sa.getSabun()+"|"+sa.getName()+"|"+ 
//			sa.getDept()+"|"+sa.getLoc()+"\n";
//			
//			fos.write(save.getBytes());
//			fos.close();
//			System.out.println("사원저장완료");
//			
//			
//			
//		}catch(Exception ex) {}
